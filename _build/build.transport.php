 ...
 */
/**
 * Build RefreshCache Package
 *
 * Description: Build script for RefreshCache package
 * @package refreshcache
 * @subpackage build
 */

/* Set package info be sure to set all of these */
define('PKG_NAME','RefreshCache');
define('PKG_NAME_LOWER','refreshcache');
define('PKG_VERSION','1.0.1');
define('PKG_RELEASE','beta1');
define('PKG_CATEGORY','RefreshCache');
